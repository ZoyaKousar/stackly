          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Onboarding Call</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Integrations</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Account Settings</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Domain Connections</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Reports & Dashboards</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Lists</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Payments</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Automations</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Pipelines</li>
              </ul>
            </Card>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Automations</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Pipelines</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Pro Suite: Paid Ads Deal Revenue Tracking</li>
              </ul>
            </Card>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Data Cleanup</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Custom Reporting</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Sales + Marketing Alignment</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Ad-Hoc Requests</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Automation Strategy</li>
              </ul>
            </Card>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Integrated Marketing Strategy</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Integrated Sales Strategy</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Solution-Based Project Support</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Industry-Specific Guidance</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Sales Enablement</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Marketing Enablement</li>
              </ul>
            </Card>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> 1-on-1 Training Hours</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Custom Roadmaps</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Dedicated Team Support</li>
              </ul>
            </Card>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Landing Pages</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Email Templates</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> CTA Creation</li>
              </ul>
            </Card>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Contacts</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Deals</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Account / Billing</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Team Structuring</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Integrations</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-pink-500" /> Workflows</li>
              </ul>
            </Card>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="inline-block px-4 py-2 bg-white rounded-full mb-6">
                  <span className="text-2xl font-bold bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent">One Week Bath</span>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-pink-200">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        <div className="text-3xl font-bold bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent">$600,000+</div>
              ...
              <div className="relative h-96 rounded-2xl overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-400 via-red-400 to-pink-400"></div>
