          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Audience</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Media planning + Forecasting</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Trend Analysis + Relative Market Share Research</li>
              </ul>
            </Card>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Google Ads</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Microsoft Ads</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Youtube</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> GDN (Prospecting + Remarketing)</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Performance Max</li>
              </ul>
            </Card>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Bi-Weekly Meetings w/ Agendas</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Live Metrics Dashboard</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> QBRs</li>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Callrail</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Semrush</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> PixisAI</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Feed Management (TBD)</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> ClickCease</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> GA4 Setup + Analysis</li>
              </ul>
            </Card>
            ...
            <Card className="p-8 bg-white/90 backdrop-blur-sm hover:shadow-xl transition-all">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Support Team</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Daily/Weekly account monitoring</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> 24 Business Hour Email Response</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Ad Copy Creation + A/B Testing</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Conversion + ROI Tracking Setup</li>
                <li className="flex items-center gap-2"><Check className="w-4 h-4 text-[#2aaaea]" /> Budget + Bid Strategy Management</li>
              </ul>
            </Card>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <Card key={i} className="overflow-hidden hover:shadow-xl transition-all group">
                <div className="relative h-64 bg-gradient-to-br from-[#111a42] via-[#2aaaea] to-cyan-400">
